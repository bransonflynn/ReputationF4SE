...
namespace RE
{
	...
	public:
		...
		char maxFilePath[REX::W32::MAX_PATH]; // 0C4
	};
	...
	{
	public:
		inline static constexpr auto RTTI{ RTTI::NiStream };
		inline static constexpr auto VTABLE{ VTABLE::NiStream };
		...
		char fileName[REX::W32::MAX_PATH];						   // 208
		...
		char lastLoadedRTTI[REX::W32::MAX_PATH];				   // 3E4
		std::uint32_t lastError;								   // 4E8
		char lastErrorMessage[REX::W32::MAX_PATH];				   // 4EC
		char filePath[REX::W32::MAX_PATH];						   // 5F0
	};

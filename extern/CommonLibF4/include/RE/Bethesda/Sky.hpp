...
namespace RE
{
	...
	public:
		...
		[[nodiscard]] static Sky* GetSingleton()
		{
			...
			static REL::Relocation<func_t> func{ REL::RelocationID(484694, 2192448) };
			return func();
		}
		...
		void ForceWeather(TESWeather* a_weather, bool a_override)
		{
			...
			static REL::Relocation<func_t> func{ REL::RelocationID(698558, 2208861) };
		...
		void ResetWeather()
		{
			...
			static REL::Relocation<func_t> func{ REL::RelocationID(6511, 2208860) };
			return func(this);
		}

...
def make_header(a_directory, a_filename, a_exclude):
	...
	with open(a_directory + "/" + a_filename, "w", encoding="utf-8") as out:
		...
		out.write("\n")
		out.write('#include "F4SE/Impl/PCH.hpp"\n')
		out.write("\n")
...
def main():
	...
	make_header("F4SE", "F4SE.hpp", { "Impl" })
	make_header("RE", "Fallout.hpp", { "NiRTTI_IDs.hpp", "RTTI_IDs.hpp", "VTABLE_IDs.hpp", "msvc" })

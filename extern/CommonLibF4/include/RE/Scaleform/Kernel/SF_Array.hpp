...
namespace RE::Scaleform
{
	...
	template <class T, class Allocator, class SizePolicy>
	struct ArrayData
		: public ArrayDataBase<T, Allocator, SizePolicy> // 00
	{
	public:
	};

	template <class T, class Allocator, class SizePolicy>
	struct ArrayDataDH : ArrayDataBase<T, Allocator, SizePolicy>
	{
	public:
		// members
	...
	class Array
		: public ArrayBase<ArrayData<T, AllocatorGH<T, SID>, SizePolicy>> // 00
	{
	public:
	};

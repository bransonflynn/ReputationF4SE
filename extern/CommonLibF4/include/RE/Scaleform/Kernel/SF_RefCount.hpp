...
namespace RE::Scaleform
{
	...
	{
	public:
		inline static constexpr auto RTTI{ RTTI::Scaleform__RefCountImplCore };
		inline static constexpr auto VTABLE{ VTABLE::Scaleform__RefCountImplCore };
	...
	{
	public:
		inline static constexpr auto RTTI{ RTTI::Scaleform__RefCountImpl };
		inline static constexpr auto VTABLE{ VTABLE::Scaleform__RefCountImpl };

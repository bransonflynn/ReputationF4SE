...
namespace RE
{
	...
	{
	public:
		inline static constexpr auto RTTI{ RTTI::ReferenceEffectController };
		inline static constexpr auto VTABLE{ VTABLE::ReferenceEffectController };
	...
	{
	public:
		inline static constexpr auto RTTI{ RTTI::ActiveEffectReferenceEffectController };
		inline static constexpr auto VTABLE{ VTABLE::ActiveEffectReferenceEffectController };
	...
	{
	public:
		inline static constexpr auto RTTI{ RTTI::SkyEffectController };
		inline static constexpr auto VTABLE{ VTABLE::SkyEffectController };

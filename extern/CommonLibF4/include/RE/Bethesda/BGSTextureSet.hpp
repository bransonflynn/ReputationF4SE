...
namespace RE
{
	...
	public:
		...
		// members
		REX::Enum<LightingShaderEnum, std::uint32_t> lightingShader;				   // 004
		...
		bool alphaBlend;															   // 078
		REX::Enum<NiAlphaProperty::AlphaFunction, std::uint32_t> alphaSrcBlendMode;	   // 07C
		REX::Enum<NiAlphaProperty::AlphaFunction, std::uint32_t> alphaDestBlendMode;   // 080
		bool alphaTest;																   // 084
		REX::Enum<NiAlphaProperty::TestFunction, std::uint32_t> alphaTestFunction;	   // 088
	...
	public:
		...
		inline static constexpr auto FORMTYPE{ ENUM_FORMTYPE::kTXST };
